...
from idbbilling import IdbServer
...
versionString = "0.0.1"
applicationNameString = "idbbillingserver"
applicationDescriptionString = "IDB Billing - tools to store and manage IDB bills remotely"
