...
class IdbConfig:
    ...
    def getConfig(jscConfigFilePath: str, connectionName: str) -> dict:
        ...
        if configuration:
            ...
            if connectionType:
                if connectionType == 'IdentityBilling.V1':
    ...
    def getIdentityBankV1Config(section: str, configuration: jsonsimpleconfig.jscdata.JscData) -> dict:
        sectionConnectionBilling = '{}."configuration"."connection"."billing"'.format(section)
        configuration = {
            'connectionBilling': configuration.getSection(sectionConnectionBilling),
        }
