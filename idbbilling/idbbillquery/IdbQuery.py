...
class IdbQuery:
    ...
    def execute(configuration: dict,
        ...
        if configuration['connectionType'] == 'IdentityBilling.V1':
        ...
        try:
            if isinstance(queryData, dict):
                ...
                if queryData['service']:
                    if queryData['service'] == 'billing':
                        returnValue = IdbQueryBilling.executeQuery(configuration, queryData)
